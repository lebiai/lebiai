//! Per-turn system prompt for the desktop GUI.
//! Aligns with the work-and-companion product protocol and Progressive Disclosure.
...
impl<'a> ContextSources<'a> {
    pub fn build_turn_system(&self, user_query: &str) -> String {
        ...
        // Relevant full bodies for this turn (legacy path — same idea as CLI).
...
mod tests {
    ...
    fn companion_not_chatbot() {
        ...
        assert!(s.contains("work companion") || s.contains("work partner"));
